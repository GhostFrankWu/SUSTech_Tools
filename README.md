...
# 不可用于小学期第一天选课
# 不可用于小学期第一天选课
# [小学期的选课方式是不同的，目前该脚本不可用于小学期选课，请有需要使用的同学自行更改选课方式和学年信息](https://github.com/GhostFrankWu/SUSTech_Tools/blob/main/main.py#L78-L87)
`P.S. 小学期是既选即得制度，所以要通过其他方式获取参数中的选课方式`
